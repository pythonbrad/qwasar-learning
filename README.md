...
This step has been done using the [terraform documentation](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/) of AWS.
...
```
git clone https://github.com/awslabs/serverless-photo-recognition/ --depth 1
```
...
**NB**: Before each deployment, and based on your change, you will have to check the change on the `src/main/kotlin/com/budilov/Properties.kt`.
